package ru.larkin.customstarter.audit.aspect;
...
import ru.larkin.customstarter.audit.model.Param;
...
public class AuditAspect {
    ...
    @Around("@annotation(ru.larkin.customstarter.audit.annotation.WeylandWatchingYou)")
